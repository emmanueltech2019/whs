  ...
  return (
    <div className="mb-40">
      ...
      <div className=" md:px-32 py-20 px-5 md:h-[100vh] h-fit text-center">
        <h2 className="text-2xl font-bold mb-4 text-[#449DD1] text-center">
          Pricing Option
        </h2>
        <span className="text-[#6B6B6B] py-10 mb-10">
          Take control of your health with transparent pricing – Contact us
